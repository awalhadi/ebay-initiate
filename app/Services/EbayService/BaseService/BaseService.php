<?php
namespace App\Services\EbayService\BaseService;

use GuzzleHttp\Psr7\Request;
use Psr\Http\Message\ResponseInterface;
use App\Services\EbayService\Types\BaseType;
use App\Services\EbayService\Parser\XmlParser;
use App\Services\EbayService\ConfigurationResolver;

// use App\Services\EbayService\Parser\XmlParser;
// use App\Services\EbayService\ConfigurationResolver;
// use App\Services\EbayService\Credentials\CredentialsProvider;
// use \App\Services\EbayService as Functions;
// use GuzzleHttp\Psr7\Request;
// use Psr\Http\Message\ResponseInterface;
...
{
    /**
     * Helper content when build requests that contain attachments.
     */
    const CRLF = "\r\n";
    ...
    /**
     * @var \App\Services\EbayService\ConfigurationResolver Resolves configuration options.
     */
    private $resolver;
    ...
    public static function getConfigDefinitions()
    {
        return [
            'profile' => [
                'valid' => ['string'],
                'fn'    => 'App\Services\EbayService\applyProfile',
            ],
            'compressResponse' => [
                'valid'   => ['bool'],
                'default' => false
            ...
            'credentials' => [
                'valid'   => ['App\Services\EbayService\Credentials\CredentialsInterface', 'array', 'callable'],
                'fn'      => 'App\Services\EbayService\applyCredentials',
                'default' => [CredentialsProvider::class, 'defaultProvider']
            ],
            'debug' => [
                'valid'   => ['bool', 'array'],
                'fn'      => 'App\Services\EbayService\applyDebug',
                'default' => false
            ],
            'httpHandler' => [
                'valid'   => ['callable'],
                'default' => 'App\Services\EbayService\defaultHttpHandler'
            ],
            'httpOptions' => [
                'valid'   => ['array'],
                'default' => []
     ...
     *
     * @return \App\Services\EbayService\Credentials\CredentialsInterface
     */
     ...
     * @param \App\Services\EbayService\Types\BaseType $request Request object containing the request information.
