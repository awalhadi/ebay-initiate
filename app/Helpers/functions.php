...
use App\Services\EbayService\Debugger;
use App\Services\EbayService\HttpHandler;
use App\Services\EbayService\Credentials\Credentials;
use App\Services\EbayService\Credentials\CredentialsProvider;
use App\Services\EbayService\Credentials\CredentialsInterface;
 ...
 * @return array The merged array.
 */
function arrayMergeDeep(...$arrays)
{
    return arrayMergeDeepArray($arrays);
}
